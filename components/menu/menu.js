			...
			<div className='menu'>
				<div className='menu-navigation'>
					<nav className='nav'>
						...
						<div className='nav-item'>
							...
							<Link href='/'>
								<a className='nav-item__inner' data-cursor-target>
									<h1>Home</h1>
								</a>
							</Link>
						</div>
				...
				<div className='menu-footer'>
					<div className='socials'>
						<div className='link' data-cursor-target data-cursor-stick>
					...
					<div>
						<a href='#' className='link email-link' data-cursor-target data-cursor-stick>
